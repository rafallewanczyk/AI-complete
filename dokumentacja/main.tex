...
\title{
    Generowanie automatycznych podpowiedzi \\w środowiskach do programowaniaa
}
...
\input{tex/2-podloze_pracy}    % Umożliwia to również łatwą migrację do nowej wersji szablonu:
\input{tex/3-metody} % wystarczy podmienić swoje pliki main.tex i eiti-thesis.cls
