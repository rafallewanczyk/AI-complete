...
class TestModels(CorrectnessTest):
    ...
    exception_tabel = {
        'cntk_Keras_resnet18',                      
        'cntk_Keras_resnet152',                     
        'cntk_Tensorflow_resnet18',                 
        'cntk_Tensorflow_resnet152',                
        'tensorflow_Cntk_inception_v1',             
        'tensorflow_Cntk_resnet_v1_50',             
        'tensorflow_Cntk_resnet_v2_50',             
        'tensorflow_Cntk_resnet_v1_152',            
        'tensorflow_Cntk_resnet_v2_152',            
        'tensorflow_Cntk_mobilenet_v1_1.0',         
        'tensorflow_Cntk_mobilenet_v2_1.0_224',     
        'tensorflow_Caffe_mobilenet_v1_1.0',        
        'tensorflow_Caffe_mobilenet_v2_1.0_224',    
        'tensorflow_frozen_MXNet_inception_v1',     
        'tensorflow_MXNet_inception_v3',            
        'darknet_Keras_yolov2',                     
        'darknet_Keras_yolov3',                     
    }
    ...
    if TEST_ONNX and TEST_ONNX.lower() == 'true':
        ...
        test_table = {
            'cntk' : {
                'inception_v3'  : [CntkEmit, PytorchEmit, TensorflowEmit], 
            ...
            'mxnet' : {
                ...
                'imagenet1k-resnext-101-64x4d' : [CaffeEmit, CntkEmit, CoreMLEmit, MXNetEmit, PytorchEmit, TensorflowEmit], 
                'imagenet1k-resnext-50'        : [CaffeEmit, CntkEmit, CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
            },

            'caffe' : {
                'alexnet'       : [CaffeEmit, CntkEmit, CoreMLEmit, MXNetEmit, PytorchEmit, TensorflowEmit], 
                'inception_v1'  : [CaffeEmit, CntkEmit, CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
                'inception_v4'  : [CntkEmit, CoreMLEmit, KerasEmit, PytorchEmit, TensorflowEmit], 
                'resnet152'     : [CaffeEmit, CntkEmit, CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit],
                ...
                'xception'      : [CoreMLEmit, CntkEmit, MXNetEmit, PytorchEmit, TensorflowEmit], 
            },
            ...
            'tensorflow' : {
                ...
                'facenet'               : [MXNetEmit, TensorflowEmit, KerasEmit, PytorchEmit, CaffeEmit], 
            },

            'tensorflow_frozen' : {
                'inception_v1'      : [TensorflowEmit, KerasEmit, MXNetEmit, CoreMLEmit], 
                'inception_v3'      : [TensorflowEmit, KerasEmit, MXNetEmit, CoreMLEmit], 
                'mobilenet_v1_1.0'  : [TensorflowEmit, KerasEmit, MXNetEmit, CoreMLEmit],
                'facenet'           : [MXNetEmit, TensorflowEmit, KerasEmit] 
            },
            ...
            'paddle' : {
                'resnet50': [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit], 
                'resnet101': [CoreMLEmit, KerasEmit, MXNetEmit, PytorchEmit, TensorflowEmit], 
            },
            ...
            'pytorch' : {
                ...
                'inception_v3': [CaffeEmit, CoreMLEmit, KerasEmit, PytorchEmit, TensorflowEmit],  
